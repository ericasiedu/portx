...
class ExportPdf extends FPDF{
    ...
    function topBody(){
        ...
        $this->Cell(190,6,$this->invoice_title.' ('.$this->trade_type.')',0,1,'L');
    ...
    function firstBody(){
        ...
        $this->SetFont('Arial','B',8.8);
        $this->Cell(63.3,6,'Shipper',0,0);
        $this->Cell(63.3,6,'Shipping Line',0,0);
        $this->Cell(63.3,6,'Customer',0,1);
        ...
        $y = $this->GetY();
        $x = $this->GetX();
        $this->MultiCell(63.3,5,$this->shipping_line,0,'L',0);
        $this->SetXY($x+$width,$y);
        $this->MultiCell(63.3,5,$this->customer,0,'L',0);
        $this->Ln(2);

        $this->SetFont('Arial','B',8.8);
        $this->Cell(63.3,6,'Vessel',0,0);
        $this->Cell(40,6,'Voyage No',0,0);
        $this->Cell(50,6,'Booking Number',0,0);
        $this->Cell(35,6,'Booking Date',0,1);

        $this->SetFont('Arial','',8.8);
        $this->Cell(63.3,6,$this->vessel,0,0);
        $y = $this->GetY();
        $x = $this->GetX();
        $this->MultiCell(40,6,$this->voyage_no,0,"L");
        $this->SetXY($x+40,$y);
        $this->Cell(50,6,$this->booking_number,0,0);
        $this->Cell(35,6,$this->booking_date,0,1);
        $this->Ln(5);

        $this->SetFont('Arial','B',8.8);
        $this->Cell(190,6,'Container(s)',0,1);
