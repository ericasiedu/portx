...
class ExportReceiptPdf extends FPDF{
    public $company_name;
    public $reciept_no;
    public $invoice_no;
    public $tin_no;
    ...
    function import_Fbody(){
        ...
        $this->SetFont('Arial','B',8.8);
        $this->Cell(63.3,6,$this->consignee_title,0,0);
        $this->Cell(63.3,6,'Agent',0,0);
        $this->Cell(63.3,6,'',0,1);
        $this->SetFont('Arial','',8.8);
        $this->Cell(63.3,6,$this->exporter,0,0);
        ...
        $this->SetFont('Arial','B',8.8);
        $this->Cell(32.5,6,'Booking Number',0,0);
