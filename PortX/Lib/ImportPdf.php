...
class ImportPdf extends FPDF{
    ...
    function topBody(){
        ...
        $this->Cell(190,6,$this->invoice_title,0,1,'L');
        $this->Ln(2);
    ...
    function import_Fbody(){
        ...
        $this->SetFont('Arial','B',8.8);
        $this->Cell(47.5,6,'Importer',0,0);
        $this->Cell(47.5,6,'Agency',0,0);
        $this->Cell(47.5,6,'Release Instructions',0,0);
        $this->Cell(47.5,6,'Customer',0,1);
        $this->SetFont('Arial','',8.8);
        $width = 47.5;
        $y = $this->GetY();
        $x = $this->GetX();
        ...
        $y = $this->GetY();
        $x = $this->GetX();
        $this->MultiCell(47.5,5,$this->agent,0,'L',0);
        $this->SetXY($x+$width,$y);
        $width = 47.5;
        $y = $this->GetY();
        $x = $this->GetX();
        $this->MultiCell(47.5,5,$this->release_instruction,0,'L',0);
        $this->SetXY($x+$width,$y);
        ...
        $this->SetXY($x+$width,$y);
        $this->MultiCell(47.5,5,'',0,'L',FALSE);
        $this->Ln(10);
        ...
        $y = $this->GetY();
        $x = $this->GetX();
        $this->MultiCell(29.6,6,$this->voyage_no,0,"L");
        $this->SetXY($x+29.6,$y);
        ...
        $this->Cell(31.6,6,'Container(s)',0,1);
    ...
    function tableBody(){
        ...
        if ($waiver_applied) {
            ...
            $this->SetFont('Arial', '', 8.8);
            $this->Cell(25, 7, number_format($this->waiver_amount, 2), 1, 1, 'C');
        }
