...
<main>
    ...
    <div class="main-content">
        ...
        <div class="card">
            <h4 class="card-title"><strong>Invoice Payment</strong> Records</h4>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 table-responsive">
                        ...
                        <table id="invoice_payment" class="display table">
                            <thead>
                            <th>Trade Type</th>
                            <th>Number</th>
                            <th>BL Number</th>
