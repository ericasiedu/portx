<?php
use Lib\ACL;
$system_object="invoice-waivers";
ACl::verifyRead($system_object);
$title = 'Invoice Waivers';  ?>
<?php $billingTransactions = 'active open'; ?>
<?php $invoiceWaivers = 'active'; ?>
...
<main>
    ...
    <div class="main-content">
        ...
        <div class="card">
            <h4 class="card-title"><strong>Invoice</strong> Waivers</h4>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 table-responsive">
                        ...
                        <table id="invoice_waiver" class="display table">
                            <thead>
                                <th>Trade Type</th>
                                <th>Number</th>
                                <th>BL Number</th>
