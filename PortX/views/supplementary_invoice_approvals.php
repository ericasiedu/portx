...
$title = 'Supplementary Invoice Approvals';
$system_object="supplementary-invoice-approvals";
ACl::verifyRead($system_object);
?>
<?php $suppBillingTransactions = 'active open'; ?>
<?php $supp_invoice_approvals = 'active'; ?>
...
<main>
    ...
    <div class="main-content">
        ...
        <div class="card">
            <h4 class="card-title"><strong>Supplementary Invoice</strong> Approvals</h4>
            <div class="card-body">
<!--                <div id="customForm">-->
<!--                    <editor-field name="deferral_date"></editor-field>-->
<!--                </div>-->
                ...
                <div class="row">
                    <div class="col-md-12 table-responsive">
                        ...
                        <table id="supp_invoice_approvals" class="display table">
                            <thead>
                                <th>Trade Type</th>
                                <th>Number</th>
                                <th>BL Number</th>
    ...
    <script>
        ...
        $(document).ready(function () {
            SupplementaryInvoiceApproval.iniTable();
        });
