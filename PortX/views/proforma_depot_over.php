...
$proforma_depot_overview = 'active';
...
<main>
    <div class="main-content">
        <div class="card">
            <h4 class="card-title"><strong>Proforma</strong> Depot Overview <span class="trade-filter">Trade Type
            ...
            <script>
                $(document).ready(function() {
                    ...
                    var can_move_ucl = false;
                    ProformaDepotOver.iniTable(can_move_ucl);
                });
            </script>