...
$system_object = "invoicing";
ACl::verifyRead($system_object);
$title = 'Invoicing';
$billingTransactions = 'active open';
$invoicing = 'active';
...
<main>
    <div class="main-content">
        <div class="card">
            <h4 class="card-title"><strong>Invoicing</strong></h4>
            <div class="card-body">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="modal modal-center fade" id="preview-modal" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="manualHeader">Invoice Preview</h4>
                    ...
                    <div class="modal-footer">
                    <button type="button" id="" class="btn btn-primary">GENERATE INVOICE
                    </button>
                    </div>
                </div>
            </div>
