...
use Lib\ACL,
    Lib\BillTansaction;
$system_object="supplementary-invoice-waivers";
ACl::verifyRead($system_object);
$title = 'Supplementary Invoice Waiver';  ?>
<?php $suppBillingTransactions = 'active open'; ?>
<?php $supp_invoice_waiver = 'active'; ?>
...
<main>
    ...
    <div class="main-content">
        ...
        <div class="card">
            <h4 class="card-title"><strong>Supplementary Invoice</strong> Waiver</h4>
            <div class="card-body">
                <!--                <div id="customForm">-->
                ...
                <div class="row">
                    <div class="col-md-12 table-responsive">
                        ...
                        <table id="supplementary_invoice_waiver" class="display table">
                            <thead>
                            <th>Trade Type</th>
                            <th>Number</th>
                            <th>BL Number</th>
    ...
    <script>
        ...
        $(document).ready(function () {
            SupplementaryInvoiceWaiver.iniTable();
        });
